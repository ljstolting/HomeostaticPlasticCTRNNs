...
// Different circuit samples for OG, HP on, HPoff
// ***************************************
...
const double Circuits = 10000; //10^4 circuits per circuit size
const double Repetitions = 10; //# of random initial conditions to test from

const double HPPlasticBoundary = 0.25;
const int stages = 1; //how many stages of transient of length specified above
int HPonwhen[stages];
